...
namespace _036_MoviesMvcWissen.Controllers
{
    public class ReportsController : Controller
    {
        ...
        private void GetModel(ReportsMoviesViewModel reportsMoviesViewModel)
        {
            ...
            var query = from m in movieQuery
                        join md in movieDirectorQuery
                        on m.Id equals md.MovieId into moviemoviedirector
                        from sub_movie_moviedirector in moviemoviedirector.DefaultIfEmpty()
            ...
            var list = query.ToList().Select(e => new MovieReportsModel()
            {
                MovieId = e.MovieId,
